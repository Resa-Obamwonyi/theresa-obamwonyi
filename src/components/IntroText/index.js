...
const IntroText=() => {
    ...
    return (
        <IntroTextStyle>  
            ...
            <span className="pop-color">Creative</span><br />
            Technical Writer.</h1>
            ...
            <Button link="https://drive.google.com/file/d/1zPVfT3IH4k9pVhUpAeaY-U4dJMEFMLDa/view?usp=sharing" width="200">Download Resume</Button>
        </IntroTextStyle>
        )
}
